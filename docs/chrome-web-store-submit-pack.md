...
本文件用于正式提交或更新 Chrome Web Store 时复制填写。

## 上传包

上传文件：

`release/cat-highlighter-v1.7-chrome-web-store.zip`
...
General optimizations and experience improvements.
...
https://github.com/Kakauiber/Cat_Highlighter/issues
