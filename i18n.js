...
(function () {
  ...
  const CATALOGS = {
    zh_CN: {
      ...
      feedbackEmailSubject: '[划线猫反馈]',
      feedbackEmailPrompt: '请描述您遇到的问题或希望增加的功能：',
      feedbackExtensionVersion: '插件版本',
      feedbackOperatingSystem: '操作系统',
      unknownOperatingSystem: '未知',
      ...
      keyboardShortcutsDesc: 'Mac 使用 Control + Y/B/R/U，Windows/Linux 使用 Alt + Y/B/R/U 快速高亮或划线。',
      keyboardShortcutsDescMac: '选中文本后，可使用 Control + Y/B/R/U 快速高亮或划线。',
      keyboardShortcutsDescDefault: '选中文本后，可使用 Alt + Y/B/R/U 快速高亮或划线。',
      keyboardShortcutsEnable: '启用快捷键',
      manageTags: '管理标签',
      manageTagsDesc: '重命名或删除页面标签。',
      tagFilterLabel: '标签',
      allTags: '全部标签',
      untaggedPages: '无标签',
      noTags: '暂无标签',
      addTag: '+ 标签',
      addTagPrompt: '输入标签，多个标签可用逗号分隔：',
      removeTag: '移除标签：{{tag}}',
      renameTag: '重命名',
      renameTagPrompt: '将“{{tag}}”重命名为：',
      deleteTag: '删除',
      deleteTagConfirm: '确定从所有页面中删除“{{tag}}”标签吗？\n\n这只会移除标签，不会删除页面、高亮或笔记。',
      tagPageCount: '{{countLabel}}',
      exportConfig: '导出配置',
      exportTemplateTitle: '导出模板',
      exportTemplateDesc: '自定义 Markdown 与笔记类导出的页面结构。',
      exportTemplateScope: '模板会逐页应用于 Markdown、墨问、Notion、Obsidian 和思源；HTML 与复制保持原样。',
      exportTemplateOptional: '这是可选功能，保持默认模板即可正常导出。',
      exportTemplateIntro: '导出时，花括号中的变量会自动替换为页面内容。你可以修改固定文字、Markdown 标题和章节顺序，也可以删除不需要的部分；请勿修改变量名称。点击下方变量按钮，可将变量插入光标位置。',
      pageTemplate: '页面模板',
      availableVariables: '可用变量',
      insertVariable: '插入变量',
      exportTemplateHelp: '建议使用 section 变量：没有笔记或标注时会自动省略整个章节。多页面导出会按原顺序逐页套用模板。',
      exportTemplateGuideTitle: '查看变量说明与示例',
      exportTemplateEditableTitle: '可以修改什么',
      exportTemplateEditableText: '修改普通文字、Markdown 标题符号和章节顺序。',
      exportTemplateEditableVariables: '调整或删除变量，但不要修改花括号内的变量名称。',
      exportTemplateEditableLimits: '暂不支持条件判断、循环、自定义颜色或复杂排版。',
      exportTemplateVariableTitle: '变量说明',
      exportTemplateExampleTitle: '示例',
      exportTemplateExample: '# {{title}}\n整理日期：{{date}}\n{{source_link}}\n\n{{note_section}}\n\n{{highlights_section}}',
      saveTemplate: '保存模板',
      restoreDefault: '恢复默认',
      exportTemplateSaved: '导出模板已保存。',
      exportTemplateReset: '已恢复默认导出模板。',
      exportTemplateLoadFailed: '加载导出模板失败，请稍后重试。',
      exportTemplateSaveFailed: '保存导出模板失败，请稍后重试。',
      exportTemplateEmpty: '模板不能为空。',
      exportTemplateTooLong: '模板内容过长，请缩短后重试。',
      exportTemplateUnsupported: '包含不支持的变量：{{variables}}',
      restoreDefaultTemplateConfirm: '确定恢复默认导出模板吗？当前自定义内容将被替换。',
      templateVarTitle: '页面标题',
      templateVarUrl: '原始网址',
      templateVarSourceLink: '可点击的原文链接',
      templateVarDate: '导出日期',
      templateVarNote: '页面笔记正文',
      templateVarHighlights: '标注列表',
      templateVarNoteSection: '完整笔记章节，无笔记时留空',
      templateVarHighlightsSection: '完整标注章节，无标注时留空',
    ...
    en: {
      ...
      managePage: 'Manager',
      feedbackAndSuggestions: 'Feedback',
      feedbackEmailSubject: '[Cat Highlighter Feedback]',
      feedbackEmailPrompt: 'Please describe the problem you encountered or the feature you would like to request:',
      feedbackExtensionVersion: 'Extension version',
      feedbackOperatingSystem: 'Operating system',
      unknownOperatingSystem: 'Unknown',
      ...
      keyboardShortcutsDesc: 'Use Control + Y/B/R/U on Mac, or Alt + Y/B/R/U on Windows/Linux to highlight or underline quickly.',
      keyboardShortcutsDescMac: 'After selecting text, use Control + Y/B/R/U to highlight or underline quickly.',
      keyboardShortcutsDescDefault: 'After selecting text, use Alt + Y/B/R/U to highlight or underline quickly.',
      keyboardShortcutsEnable: 'Enable Shortcuts',
      manageTags: 'Manage Tags',
      manageTagsDesc: 'Rename or delete page tags.',
      tagFilterLabel: 'Tag',
      allTags: 'All Tags',
      untaggedPages: 'No Tags',
      noTags: 'No tags yet',
      addTag: '+ Tag',
      addTagPrompt: 'Enter tags. Separate multiple tags with commas:',
      removeTag: 'Remove tag: {{tag}}',
      renameTag: 'Rename',
      renameTagPrompt: 'Rename “{{tag}}” to:',
      deleteTag: 'Delete',
      deleteTagConfirm: 'Delete “{{tag}}” from all pages?\n\nThis only removes the tag. Pages, highlights, and notes will not be deleted.',
      tagPageCount: '{{countLabel}}',
      exportConfig: 'Export Settings',
      exportTemplateTitle: 'Export Template',
      exportTemplateDesc: 'Customize the page structure used by Markdown and note exports.',
      exportTemplateScope: 'The template is applied to each page exported to Markdown, Mowen, Notion, Obsidian, or SiYuan. HTML and copy output remain unchanged.',
      exportTemplateOptional: 'This is optional. Keep the default template to export normally.',
      exportTemplateIntro: 'Variables inside braces are replaced with page content during export. You can edit fixed text, Markdown headings, and section order, or remove parts you do not need. Do not rename variables. Click a variable below to insert it at the cursor.',
      pageTemplate: 'Page Template',
      availableVariables: 'Available Variables',
      insertVariable: 'Insert Variable',
      exportTemplateHelp: 'Use the section variables to omit an entire section when a page has no notes or highlights. Multi-page exports apply the template in the original page order.',
      exportTemplateGuideTitle: 'View Variable Guide and Example',
      exportTemplateEditableTitle: 'What You Can Change',
      exportTemplateEditableText: 'Edit regular text, Markdown heading markers, and section order.',
      exportTemplateEditableVariables: 'Reorder or remove variables, but do not rename anything inside the braces.',
      exportTemplateEditableLimits: 'Conditions, loops, custom colors, and complex layouts are not supported yet.',
      exportTemplateVariableTitle: 'Variable Guide',
      exportTemplateExampleTitle: 'Example',
      exportTemplateExample: '# {{title}}\nExported on: {{date}}\n{{source_link}}\n\n{{note_section}}\n\n{{highlights_section}}',
      saveTemplate: 'Save Template',
      restoreDefault: 'Restore Default',
      exportTemplateSaved: 'Export template saved.',
      exportTemplateReset: 'Default export template restored.',
      exportTemplateLoadFailed: 'Unable to load the export template. Try again later.',
      exportTemplateSaveFailed: 'Unable to save the export template. Try again later.',
      exportTemplateEmpty: 'The template cannot be empty.',
      exportTemplateTooLong: 'The template is too long. Shorten it and try again.',
      exportTemplateUnsupported: 'Unsupported variables: {{variables}}',
      restoreDefaultTemplateConfirm: 'Restore the default export template? Your custom template will be replaced.',
      templateVarTitle: 'Page title',
      templateVarUrl: 'Original URL',
      templateVarSourceLink: 'Clickable original link',
      templateVarDate: 'Export date',
      templateVarNote: 'Page note content',
      templateVarHighlights: 'Highlight list',
      templateVarNoteSection: 'Complete note section; empty when there is no note',
      templateVarHighlightsSection: 'Complete highlight section; empty when there are no highlights',
